...
def parse_opt():
    ...
    parser.add_argument('--att_model', type=str, default='newtopdown',
    ...
    parser.add_argument('--bert_base_768', type=bool)
    parser.add_argument('--glove_6B_300', type=bool)
    ...
    parser.add_argument('--self_critical', type=bool, default=False, help='whether use self critical training.')
